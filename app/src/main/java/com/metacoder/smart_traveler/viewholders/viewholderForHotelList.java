...
public class viewholderForHotelList extends RecyclerView.ViewHolder {
    ...
    private static viewholderForHotelList.Clicklistener mclicklistener;
    View mview;

    public viewholderForHotelList(@NonNull View itemView) {
        super(itemView);
    ...
    public void setDataToView(Context context, HotelModel model) {
