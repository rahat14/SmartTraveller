...
import com.metacoder.smart_traveler.databinding.ActivityRegisterBinding;
...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isEdit) {
            ...
            binding.passContianer.setVisibility(View.GONE);
            ...
            try {
                binding.phone.setText(model.getPh());
        ...
        binding.signUp.setOnClickListener(v -> {
            ...
            if (!isEdit) {
                ...
                if (password.isEmpty()) {
                    ...
                    binding.phone.setText("Can't Be Empty");
                }
        ...
        mauth.createUserWithEmailAndPassword(mail, password)
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        map.put("pp", "");
                        map.put("user_id", uid);
                        map.put("ph", binding.phone.getText().toString());
